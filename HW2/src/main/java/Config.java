public class Config {
    public static final String NAME = "Sai Kumar Reddy Peddholla";

    public static final String USC_ID = "5978435849";

    public static final String WEBSITE_DOMAIN = "foxnews";
